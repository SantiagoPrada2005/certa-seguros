...
import { ShieldAlert, CreditCard, Building2, User2, Eye } from "lucide-react"
...
export function ClientesTable({ clients, onSelectClient }: ClientesTableProps) {
            ...
            >
              ...
              <TableCell className="text-right">
                <div className="flex items-center justify-end gap-2">
                  <Badge variant="outline" className="bg-blue-50/50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400 gap-1 rounded-sm border-blue-200 dark:border-blue-800">
                    <ShieldAlert className="size-3" />
                    {client._count.services}
                  </Badge>
                  <Badge variant="outline" className="bg-emerald-50/50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 gap-1 rounded-sm border-emerald-200 dark:border-emerald-800">
