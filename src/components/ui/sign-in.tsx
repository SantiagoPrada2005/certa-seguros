      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            {error && <p className="text-red-500 text-sm animate-element animate-delay-200">{error}</p>}

            <form className="space-y-5" onSubmit={onSignIn} action={formAction}>
              <div className="animate-element animate-delay-300">
                <label className="text-sm font-medium text-muted-foreground">{emailLabel}</label>
                <GlassInputWrapper>
                  <input name="email" type="email" placeholder={emailPlaceholder} className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" required />
                </GlassInputWrapper>
              </div>
              ...
              <div className="animate-element animate-delay-400">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name={passwordName} type={showPassword ? 'text' : 'password'} placeholder={passwordPlaceholder} className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" required />
